    ...
    return (
      <Layout>
        ...
        <Bumper bg="bg-white">
          ...
          <p>
            <a id="contact" href="mailto:hell%6F@ka%74rinad%61w%6E.c%61?subject=I%20would%20like%20to%20commission%20a%20painting" className="btn btn-inverse">Send her an email</a>
          </p>
        </Bumper>
      </Layout>
    );
